      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="flex gap-6">
            <Link href="#" className="text-[#5D5D5D] hover:text-[#3D3D3D] transition-colors">
        ...
        <div className="flex gap-8 mb-12 text-sm">
          <Link href="#contact" className="text-[#9D9D9D] hover:text-[#5D5D5D] transition-colors">
            お問い合わせ
          </Link>
          <Link href="#school" className="text-[#9D9D9D] hover:text-[#5D5D5D] transition-colors">
            ノックの学校
          </Link>
        </div>
        ...
        <div className="flex items-center justify-between border-t border-[#D4CFC4] pt-8">
          ...
          <button 
            ...
            className="text-[#9D9D9D] hover:text-[#5D5D5D] transition-colors flex items-center gap-2"
          >
